    ...
    <main className="min-h-screen bg-void flex items-center justify-center px-6 relative">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="flex items-center gap-2 justify-center mb-8">
          <div className="w-8 h-8 rounded-full bg-violet flex items-center justify-center text-star text-sm font-semibold" aria-label="Step 1 of 2, current" aria-current="step">1</div>
          <div className="w-12 h-px bg-white/10" />
          <div className="w-8 h-8 rounded-full bg-cosmos border border-white/10 flex items-center justify-center text-muted text-sm" aria-label="Step 2 of 2">2</div>
        </div>
